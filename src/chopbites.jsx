...
function Chop() {
  ...
  return (
    <div className="text-gray-500 grid md:grid-cols-5">
      {" "}
      {/* content wrapper */}
      <div className="md:col-span-1 md:flex md:justify-end mt-5">
        {" "}
        {/* nav start */}
        <nav className="text-right">
          ...
          <ul
            className={`mt-6 bg-white rounded-lg shadow-lg px-4 py-2 transition-all duration-300 ease-in-out transform origin-top:${
              isMenuOpen
          ...
          >
            <li className="text-gray-700 font-bold py-1 hover:bg-gray-100 rounded-md transition-colors duration-200">
              <a
                href=""
                className="flex px-4 justify-end border-r-4 border-gray-700"
              >
                <span>Home</span>
                <svg
                  className="w-5 size-6 ml-2"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke-width="1.5"
      ...
      <main className="px-16 py-6 bg-gray-100 md:col-span-4">
        <div className="flex justify-center md:justify-end">
          <a
            href=""
            className="btn text-gray-700 border md:border-gray-700 hover:bg-gray-300 transition ease-out duration-500 "
          >
            Log in
          </a>
          <a
            href=""
            className="btn text-gray-700 border md:border-gray-700 hover:bg-gray-300 transition ease-out duration-500 ml-2"
          >
            Sign up
          </a>
        </div>
        ...
        <div>
            ...
            <div className="card hover:shadow-lg">
              ...
              <div className="m-4">
                <span className="font-bold">
                  Tuwo with egusi soup and ganda
                </span>
              ...
              <div className="badge">
                <svg
                  className="w-5 size-6 inline-block"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke-width="1.5"
          ...
          <div className="flex justify-center">
            <div className="btn bg-gray-200 hover:shadow-inner transform hover:scale-125 hover:bg-opacity-50 transition ease-out duration-300">
              Load more
            </div>
          </div>
        </div>
